...
import { models, PROVIDERS, getModelProvider } from '@/ai/ai-model';
import { cn } from '@/lib/utils';
import { User, Palette, Settings, Save, X } from 'lucide-react';
...
const tabItems: TabItem[] = [
  ...
  { value: 'chat', label: 'Chat Settings', icon: Settings },
];
    ...
    <div className="space-y-5">
      ...
      <div className={cn('flex items-center gap-4', isMobile ? 'pb-2' : 'pb-3')}>
        ...
        <div className="space-y-1 min-w-0">
          ...
          <p className={cn('text-muted-foreground break-all', isMobile ? 'text-xs' : 'text-sm')}>
            {user.email}
          </p>
        </div>
      </div>
...
function AppearanceTab() {
  ...
  const themes = [
    ...
    { value: 'dark', label: 'Dark', bg: 'bg-neutral-900', fg: 'bg-neutral-200' },
    { value: 'system', label: 'System', bg: 'bg-gradient-to-br from-white to-neutral-900', fg: 'bg-neutral-400' },
  ] as const;
