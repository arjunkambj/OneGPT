...
import { ArrowUp, Square, Paperclip, X, File as FileIcon, ChevronDown } from 'lucide-react';
...
function ProviderIcon({
  ...
  switch (provider) {
    ...
    case 'anthropic':
      return (
        <svg {...props} viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd">
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Tooltip delayDuration={300}>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className={cn(
                          ...
                          'hover:bg-foreground/18 hover:text-foreground hover:border-foreground/35',
                          'transition-colors',
                        )}
                    ...
                    >
                      <span className="font-medium text-[11px]">Attach files</span>
                    </TooltipContent>
                  </Tooltip>
                  ...
                  >
                    ...
                    >
                      {provider && <ProviderIcon provider={provider} size={12} />}
                ...
                <div className="flex items-center shrink-0 gap-1.5">
                  ...
                  <span className="hidden sm:inline-flex text-[10px] text-muted-foreground/50 mr-1 select-none">
                    <kbd className="font-sans">Enter</kbd>
                    <span className="mx-0.5">to send,</span>
                    <kbd className="font-sans">Shift+Enter</kbd>
